...
- **facilitator** - Can manage leads, view reports
...
role: string (required) - admin, facilitator, viewer
```
...
**Body (Form Data):**
```
role: string (optional) - admin, facilitator, viewer
...
4. **Role-Based Access:**
   - **Admin** - Full access to all endpoints
   - **Facilitator** - Can manage leads and view reports
   - **Viewer** - Read-only access to leads
