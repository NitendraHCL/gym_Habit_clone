...
| `assigned_to` | String | No | Email of assigned admin/facilitator |
...
```javascript
{
  ...
  "assigned_to": "facilitator@habithealth.com",
  ...
  "payment": {
    "status": "link_shared",
    "amount": 4200,
    "payment_link": "https://razorpay.me/habithealth/abc123",
  ...
  "comments": [
    {
      ...
      "user": "facilitator@habithealth.com",
...
- `contacted` - Admin/facilitator has contacted
...
### Purpose
Stores admin and facilitator accounts for the admin panel.
...
- `facilitator` - Limited access (view/edit leads, cannot create users)
