...
| `POST /api/admin/users` | **Create User** | Create new admin/facilitator/viewer user | ✅ Live |
...
| **User Management** | MongoDB Collection | Store admin/facilitator/viewer users | ✅ Complete |
...
| **Role-Based Access Control** | Custom Middleware | Admin, Facilitator, Viewer roles | ✅ Complete |
