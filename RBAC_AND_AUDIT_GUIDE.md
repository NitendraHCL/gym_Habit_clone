...
|-------------|--------|----------------|
| ✅ Support team logins (2-3 users) | ✅ Complete | Facilitator role |
...
#### **Role 2: Facilitator** (Support Team)
...
4. Fill in:
   - Name: "Support User 1"
   - Email: "support1@habithealth.com"
   - Password: "Support@2025"
   - Role: Facilitator ← Important!
5. Click "Create User"
```
...
**Tracked Information:**
- ✅ **User Email** - Who made the change (support1@habithealth.com)
...
5. See complete changelog:
   ```
   2025-12-14 14:30 | support1@habithealth.com
   Action: Status changed from 'new' to 'contacted'
   Reason: Customer called and confirmed interest

   2025-12-14 15:00 | support2@habithealth.com
   Action: Payment updated to 'link_shared'
   Amount: ₹14,999
   Link: https://pay.habithealth.com/xyz

   2025-12-14 15:30 | support1@habithealth.com
...
**CSV Includes:**
- Column: **Latest Status Update** - Format: `2025-12-14 14:30 | support1@habithealth.com | new → contacted | Reason: ...`
- Column: **Latest Payment Update** - Format: `2025-12-14 15:00 | support2@habithealth.com | pending → paid | Amount: ₹14999`
- Column: **Latest Plan Change** - Format: `2025-12-14 15:30 | support1@habithealth.com | Premium 6M → Elite 12M`
- Column: **All Comments** - Format: `[2025-12-14 16:00 - admin@habithealth.com] Follow-up tomorrow; ...`
...
```
1. Login: admin@habithealth.com / Admin@2025
2. Go to "Users" tab
3. Create User 1:
   - Name: Priya Sharma
   - Email: priya@habithealth.com
   - Password: Support@2025
   - Role: Facilitator
4. Create User 2:
   - Name: Rahul Kumar
   - Email: rahul@habithealth.com
   - Password: Support@2025
   - Role: Facilitator
```
...
**11:00 AM - Priya Works on Lead:**
```
1. Priya logs in: priya@habithealth.com
...
```
→ Audit log records: `priya@habithealth.com changed status to 'contacted'`
→ Timestamp: `2025-12-14 11:00:00`

**2:00 PM - Rahul Updates Payment:**
```
1. Rahul logs in: rahul@habithealth.com
2. Opens same lead: GYM_20251214_0001
3. Clicks "Update Payment"
4. Selects: "Link Shared"
5. Amount: 14999
6. Link: https://pay.habithealth.com/xyz
```
→ Audit log records: `rahul@habithealth.com updated payment to 'link_shared'`
→ Timestamp: `2025-12-14 14:00:00`

**3:00 PM - Priya Adds Follow-up:**
```
1. Priya opens lead again
2. Clicks "Add Comment"
3. Types: "Payment link sent to customer via WhatsApp"
```
→ Audit log records: `priya@habithealth.com added comment`
→ Timestamp: `2025-12-14 15:00:00`
...
4. Sees complete history:
   ...
   2025-12-14 11:00 | priya@habithealth.com
   ...
   2025-12-14 14:00 | rahul@habithealth.com
   Payment: pending → link_shared
   Amount: ₹14,999
   Link: https://pay.habithealth.com/xyz

   2025-12-14 15:00 | priya@habithealth.com
   Comment: Payment link sent to customer via WhatsApp
```

**Admin's Insights:**
- ✅ Priya handled initial contact
- ✅ Rahul processed payment link
- ✅ Priya followed up with customer
...
- [ ] **Create support team users (2-3 users)**
  ...
  - **Select Role: Facilitator** ← Important!
  - Click "Create User"
...
|---------|------------------|--------|----------|
| **Support Team Logins** | 2-3 users can login separately | ✅ YES | Role: Facilitator |
...
2. Login as admin
3. Go to "Users" tab
4. Create your 2-3 support team users with Role: Facilitator
